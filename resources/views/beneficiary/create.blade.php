...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    <h1 class="text-xl font-bold mb-4"><i class="fa-solid fa-plus mr-2"></i>Create request</h1>
    <form method="POST" action="{{ route('requests.store') }}">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="note" class="w-full border rounded px-3 py-2" rows="3" placeholder="Additional details"></textarea>
            </div>
        </div>
        <div class="mt-4">
            <button class="bg-primary-700 hover:bg-primary-800 text-white px-4 py-2 rounded"><i class="fa-solid fa-paper-plane mr-1"></i>Save</button>
