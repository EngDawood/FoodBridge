    ...
    <form method="POST" action="{{ route('requests.store') }}">
        ...
        <div class="flex flex-col space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-4">
            ...
            <div class="md:col-span-2 flex flex-col space-y-1">
                ...
                <textarea name="note" class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all" rows="3" placeholder="Additional details"></textarea>
            </div>
        </div>
